// TAKEN FROM - 
// https://github.com/kamranahmedse/redux-persist-expire/blob/master/index.js
 ...
 * @return {*}
 */
const transformPersistence = (inboundState: any, config:any) => {
 ...
 * @return {*}
 */
const transformRehydrate = (outboundState:any, config:any) => {
 ...
 */
function expireReducer(reducerKey: string, config = {}) {
