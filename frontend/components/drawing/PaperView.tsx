    ...
    <NodeViewWrapper className="draw" contentEditable={false}>
      <div className="control-group">
        <div className="button-group flex ">
          <AInput type="color" value={color} onChange={e => setColor(e.target.value)} />

          <AInput type="number" min={1} max={10} value={size} onChange={e => setSize(Number(e.target.value))} />

          <AButton variant='filled' type='primary' className='px-3 py-2' onClick={clearCanvas}>Clear</AButton>
        </div>
