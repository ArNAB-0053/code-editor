...
import {
  UsernameTooltip,
  PasswordTooltip,
} from "@/components/auth/validation-tooltip";
import { AFormItem, AInput, APopover, CFormLabel } from "@/components/ui/antd";
...
export const FormItemComponent = ({
  ...
  const showTooltip =
    name === "username" || name == "newPassword" || name === "password";
    ...
    >
      <>
        <div className="relative">
          <AInput
            value={value}
            type={showEyeBtn ? (passwordVisible ? "text" : "password") : type}
            onChange={onChange}
            onFocus={onFocus}
